...
Route::middleware('auth')->group(function() {
    ...
    Route::get('/user/{iduser}/opinions', 'ProfileController@story')->where(['iduser' => '[0-9]+']);
    Route::get('/user/{iduser}/saves', 'ProfileController@save')->where(['iduser' => '[0-9]+']);

	/*profile*/
	Route::get('/me', 'ProfileController@profile');
    Route::get('/me/notifications', 'NotifController@notifications');
    Route::get('/me/opinions', 'ProfileController@profile');
    Route::get('/me/saves', 'ProfileController@save');
